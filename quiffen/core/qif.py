...
class ParserState:
    ...
    def __init__(
        self, lenient: bool = False, debug: bool = False, num_errors_to_show: int = 10
    ):
...
class Qif(BaseModel):
    ...
    def parse(
        ...
        lenient: bool, default=False
            In lenient mode, exceptions are added to an error list
            and tried to be ignored.
            Otherwise, they are raised immediately.
        debug: bool, default=False
            In debug mode all exceptions are listed and
            the most common ones are displayed
        num_errors_to_show:int, default=10
            The number of most common errors to show in debug mode
        progress: , default=None
            tqdm progress bar to be used for progress display
        Returns
        -------
        Qif
        ...
        parser_state = ParserState(
            lenient=lenient, debug=debug, num_errors_to_show=num_errors_to_show
        )
        path = Path(path)
